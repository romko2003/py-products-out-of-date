...
@patch("datetime.date")
def test_outdated_products_some_expired(mock_date: Any) -> None:
...
@patch("datetime.date")
def test_outdated_products_all_expired(mock_date: Any) -> None:
    ...
    products = [
        {"name": "old cheese", "expiration_date":
            REAL_DATE(2022, 1, 15), "price": 70},
        {"name": "yogurt", "expiration_date":
            REAL_DATE(2022, 2, 1), "price": 25},
    ]
